...
class RoboschoolForwardWalker(SharedMemoryClientEnv):
    ...
    def create_single_player_scene(self):
        return SinglePlayerStadiumScene(gravity=9.8, timestep=0.0165/4, frame_skip=1)

    def robot_specific_reset(self):
        for j in self.ordered_joints:
            j.reset_current_position(self.np_random.uniform( low=-0.0, high=0.0 ), 0)  #were both 0
    ...
    def _step(self, a):
        ...
        self.HUD(state, a, done)  # defined at RoboschoolMujocoXmlEnv @94
        return state, sum(self.rewards), bool(done), {}

    def episode_over(self, frames):
        #print("Over, Over! pass...")
        self._reset()
